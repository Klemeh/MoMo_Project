    ...
    while (true) {
        ...
        switch(option) {
            ...
            case 2: // Sending money
                ...
                cin>>amount;
                 if(amount>balance) {
                    cout << "Not enough funds to perform this transaction!\n." << endl;
                } 
                else{
                ...
                cin>>pin;
                 if(pin==defaultpin){
                    cout << "Payment made for GHc:"<< amount << " to " <<numb2<<"\n Current Balance:"<<balance-amount<<" Available Balance:"<<balance-amount<<"\n Reference:"<<reference<<"Transaction ID:"<<ID <<"\n THANK YOU FOR USING MobileMoney TRANSFER!\n";
            }
                else{
                	cout<<"Wrong PIN\n";
				}
